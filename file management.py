...
def register():
    set_fn = input("Enter your first name. ")
    set_ln = input("Enter your last name. ")
    set_pass = input("Set a password. ")
    set_email = input("Enter your Email address. ")
    ...
    if wp_num != 1:
        wp_num = contact_num
    set_en = input("Enter your college enrollement number. ")
    ...
    with open("username.txt", "a") as u:
        u.write(username1 + "\n")        
    print("Username created successfully! You can use this usernname for further purposes.")

    with open("user and pass.txt", "a") as up:
        up.write(username1 +" " + set_pass + " " + "\n")
    
    with open ("Email and pass.txt", "a") as e:
        e.write(set_email + " " + set_pass + " " + "\n")
    ...
    if c == "Y":
        login(username1,set_pass,set_fn)
    elif c == "N":
        print("Exiting........")
    
def login(username1,set_pass,set_fn):
    global loged_in
    ...
    while i > 0:
        ...
        if username == username1 and password == set_pass:
            print(f"Login successfull. Welcome {set_fn}.")
            loged_in = True
            break
        else:
           i -= 1
...
def login_without_register():
    def with_username():
        ...
        while i > 0:
            ...
            with open("user and pass.txt", "r") as u:
                user = u.read().splitlines()
    ...
    def with_email():
        ...
        i = 3  # creating this so that the user is left with only 3 chances for login successfully.
        while i > 0:
            input_email = input("Enter a registered email: ")
            password = input("Enter your password: ")

            with open("email and pass.txt", "r") as ep:
                email = ep.read().splitlines()
            
            seperate = [line.split() for line in email]
            
            if (input_email, password) in seperate:
                print("Login successful. Welcome.")
                loged_in = True
                break
            else:
    ...
    a = input("Login with Email or username. (E/U): ").upper()
...
while loged_in == True:
    ...
    input_user = input('''1.Software Engineering.
